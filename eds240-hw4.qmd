...
# arrows pointing to each point
  ...
  labs(
    title = "Dangerously High Cesium-137 Water Concentration\nLevels in Lakes Near The Accident",
    subtitle = "Distance from Chernobyl NPP vs Relative Cs-137 Water Concentration",
  ...
  theme(
    ...
    plot.margin = margin(t = 10, r = 300, b = 100, l = 200, "pt")
  ) 
