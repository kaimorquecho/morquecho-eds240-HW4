  ...
  html:
    ...
    include-in-header:
      - text: |
          ...
          <link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Rubik+Glitch&family=Smooch+Sans:wght@100..900&display=swap" rel="stylesheet">
          ...
          a:hover {
            color: deepskyblue;
            text-shadow: 0 0 6px springgreen;
          }
          /* ---------- TITLE ---------- */
          ...
          .two-col img {
            ...
            height: auto;
            border-radius: 14px;
            box-shadow: 0 0 18px rgba(0, 255, 127, 0.4);
          }
          ...
          #toc a:hover {
            color: springgreen;
            text-shadow: 0 0 5px springgreen;
          }
          </style>
---
::: {.two-col}
...
Water Chemistry of Seven Lakes in Belarus and Ukraine 2014 - 2016, accessed through the data.gov.uk Find Open Data page.

Spatial Datasets of Radionuclide Contamination in the Ukrainian Chernobyl Exclusion Zone, accessed through the data.gov.uk Find Open Data Page.

Kaggle

Major Nuclear Plant Accidents (1957 - 2011), accessed via Kaggle.
...
The first data viz is a timeline of the history of nuclear disasters.

Then, I zoom in on the Chernobyl Nuclear Disaster and provide context for the event.

The last two data viz display Chernobyl-specific facts that underscore the severity of the accident.
